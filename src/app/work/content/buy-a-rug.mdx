...
description: E-commerce platform for a London rug retailer, migrated from Angular to Next.js. Features ElasticSearch integration, Google Sheets inventory management, and Stripe payments.
