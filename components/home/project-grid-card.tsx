...
export const ProjectGridCard = ({ project, idx }: any) => {
  return (
    <Link href={project.slug} className="group border-b odd:border-r">
      <AspectRatio ratio={3 / 2}>
        <div className="absolute inset-0 z-10 bg-primary mix-blend-overlay transition-opacity duration-500 ease-in-out group-hover:opacity-0" />
      ...
      <div className="border-t p-5 group-hover:bg-primary group-hover:text-background">
